...
public class EventHandler {
	...
	public void handleNieuwSorteerItemEvent(NieuwSorteerItemEvent e) {
		...
		service.maakNieuwSorteerItem(e.getZendingId(), e.getNaamOntvanger(), e.getPostcodeOntvanger(), e.getStraatOntvanger(), 
	...
	public void handleBevestigSorterenEvent(BevestigSorterenItemEvent e) {
	...
	public void handleBevestigVervoerenEvent(BevestigVervoerenItemEvent e) {
